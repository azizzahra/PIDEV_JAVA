...
import Controller.Event.AddLoanController;
import Controller.Event.UpdateLoanController;
...
public class LoanController {
    ...
    private void showAddDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Event/add-loan.fxml"));
            ...
            scene.getStylesheets().add(getClass().getResource("/Event/style.css").toExternalForm());
    ...
    private void showUpdateDialog(Loan loan) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Event/update-loan.fxml"));
            Parent root = loader.load();
    ...
    public void handleGoToUsers(ActionEvent actionEvent) {
        try {
            ...
            Parent loansRoot = FXMLLoader.load(
                    getClass().getResource("/Event/owner_view.fxml")
            );
    ...
    public void handleBackToPlace(ActionEvent actionEvent) {
        {
            try {
                // Load the loans management layout
                Parent loansRoot = FXMLLoader.load(
                        getClass().getResource("/Event/place.fxml")
                );
                // Get current window (stage) from the event’s source node
                Stage stage = (Stage) ((Node) actionEvent.getSource())
                        .getScene()
