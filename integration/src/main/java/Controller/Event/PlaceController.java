...
import Controller.Event.AddPlaceController;
import Controller.Event.UpdatePlaceController;
...
public class PlaceController {
    ...
    private void showAddDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Event/add-place.fxml"));
    ...
    private void showUpdateDialog(Place place) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Event/update-place.fxml"));
            Parent root = loader.load();
    ...
    public void handleGoToLoans(ActionEvent actionEvent) {
        try {
            Parent loansRoot = FXMLLoader.load(
                    getClass().getResource("/Event/loan_management.fxml")
            );
    ...
    @FXML
    public void Rhome(ActionEvent actionEvent) {
        try {
            Parent loansRoot = FXMLLoader.load(
