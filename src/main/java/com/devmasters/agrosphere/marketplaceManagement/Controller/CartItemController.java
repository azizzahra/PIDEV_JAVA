...
public class CartItemController {
    ...
    private void loadProductImage() {
        try {
            ...
            File imageFile = new File("uploads/" + prod.getProdImg());
            if (imageFile.exists()) {
                Image img = new Image(imageFile.toURI().toString(), true);
                productImage.setImage(img);
            } else {
                // Try to load from classpath resources
                String resourcePath = "/images/" + prod.getProdImg();
            ...
            try {
                ...
                // If no placeholder available, just show nothing
            }
        }
    }
